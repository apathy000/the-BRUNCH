...
const T = {
  ...
  AM: {
    ...
    heroHeadline1: "Ավելին, քան brunch —",
    heroHeadline2: "Սա ձեր սիրելի",
    heroHeadline3: "օրվա մասն է։",
    heroSub:
      "Հեղինակային նախաճաշեր, բարակ ու խրթխրթան պիցցա, specialty սուրճ և այն ջերմությունը, որը ստիպում է հյուրերին կրկին վերադառնալ։",
    heroCta2: "Բացել մենյուն",
    pill1: "🏅 Ընտանեկան մթնոլորտ",
    pill2: "☕ Specialty սուրճ",
    pill3: "✦ Մշտական հյուրեր",
    statsLabels: [
      "Google կարծիքներ",
      "Միջին գնահատական",
      "Մշտական հյուրեր",
    ...
    expTag: "Մեր մոտեցումը",
    expTitle: "Ամեն ինչ անում ենք հոգատարությամբ",
    expSub:
      "Սուրճի առաջին կաթիլից մինչև դեսերտի վերջին պատառը՝ յուրաքանչյուր մանրուք մտածված է։",
    galleryTag: "Պատկերասրահ",
    galleryTitle: "Յուրաքանչյուր ուտեստ իր պատմությունն ունի",
    galleryNote: "📸 Իրական լուսանկարներ The BRUNCH-ի խոհանոցից",
    menuTag: "Մեր մենյուն",
    menuTitle: "Թարմ պատրաստված ամեն առավոտ",
    menuSub: "Մենյու՝ ստեղծված որակյալ բաղադրիչների և ոգեշնչող բաղադրատոմսերի շուրջ։",
    aboutTag: "Մեր պատմությունը",
    aboutTitle: "Ստեղծված հարմարավետության, համի և շփման համար",
    aboutP1:
      "The BRUNCH-ը ծնվել է պարզ գաղափարից․ առավոտները պետք է հատուկ լինեն։ Ոչ շտապ, ոչ սովորական՝ պարզապես հատուկ։",
    aboutP2:
      "Մենք ստեղծել ենք վայր, որտեղ նախաճաշերը առատ են, սուրճը պատրաստվում է սիրով, իսկ անձնակազմը հիշում է ձեր անունը։",
    aboutP3:
      "Մեր մենյուի յուրաքանչյուր ուտեստ ընտրվել է, որովհետև այն իսկապես ոգեշնչում է մեզ՝ խրթխրթան պիցցայից մինչև հայտնի կիտրոնե տարտը։",
    aboutP4:
      "Երևանի սրտում գտնվող The BRUNCH-ը նախատեսված է նրանց համար, ովքեր հավատում են, որ օրվա լավագույն մասը արժանի է լավագույն սեղանին։",
    aboutCta: "Այցելե՛ք մեզ",
    aboutQuote: "«Վայրը, որտեղ բոլորը վերադառնում են»",
    reviewsTag: "Հյուրերի կարծիքներ",
    reviewsTitle: "Ինչ են ասում մեր հյուրերը",
    reviewsSub:
      "Գրված իրական հյուրերի կողմից։ Կիսվում ենք հենց այնպես, ինչպես նրանք զգացել են։",
    whyTag: "Ինչու՞ The BRUNCH",
    whyTitle: "Ավելին, քան սրճարան։ Սա փորձառություն է։",
    whyItems: [
      [
        "Արագ և ուշադիր սպասարկում",
        "Առանց երկար սպասելու։ Ջերմ վերաբերմունք և անձնակազմ, որը իսկապես հոգ է տանում։",
      ],
      [
        "Մշտական որակ",
        "Յուրաքանչյուր այց նույնքան հաճելի է, որքան առաջինը։",
      ],
      [
        "Առատ չափաբաժիններ",
        "Մենք փոքր չափաբաժինների կողմնակից չենք։ Հեռացեք կուշտ և երջանիկ։",
      ],
      [
        "Պրեմիում սուրճ",
        "Ընտրված հատիկներ, պրոֆեսիոնալ պատրաստում և barista մակարդակի որակ։",
      ],
      [
        "Ընտանեկան մթնոլորտ",
        "Վայր, որտեղ բոլորը իրենց հարմարավետ են զգում։",
      ],
      [
        "Անմոռանալի դեսերտներ",
        "Այնպիսի դեսերտներ, որոնց մասին հիշում ես տուն գնալու ճանապարհին։",
      ],
    ],
    contactTag: "Գտե՛ք մեզ",
    contactTitle: "Սեղանը սպասում է",
    contactTitleEm: "հենց ձեզ համար։",
    contactDesc:
      "Անկախ նրանից՝ մենակ հանգիստ առավոտ է, ընտանեկան հանդիպում կամ ժամադրություն՝ The BRUNCH-ում ձեզ համար միշտ տեղ կա։",
    loc: "Հասցե",
    ...
    branch2: "Dalma Garden Mall, Երևան",
    fbBtn: "Facebook",
    igBtn: "Instagram",
    cardTag: "Սրճարան & Խոհանոց",
    cardQuote: "«Դանդաղ առավոտների և հաճելի զրույցների համար»",
    cardStat1: "Գոհ հյուրեր",
    cardStat2: "Google գնահատական",
    cardStat3: "Մենյուի բաժիններ",
    cardCta: "Ամրագրել սեղան ✦",
    footerTagline: "Դանդաղ առավոտների\nև հաճելի զրույցների համար։",
    footerCopy:
      "© 2025 The BRUNCH Café & Kitchen · Բոլոր իրավունքները պաշտպանված են · Ստեղծված ☕-ով Երևանում",
    features: [
      {
        icon: "✦",
        title: "Լեգենդար նախաճաշեր",
        dish: "English Breakfast · Brunch Bowl",
        desc: "Առատ չափաբաժիններ, գեղեցիկ մատուցում և հարազատ համեր, որոնք առավոտը դարձնում են հատուկ։",
      },
      {
        icon: "◈",
        title: "Բարակ և խրթխրթան պիցցա",
        dish: "Prosciutto & Arugula · Quattro Formaggi",
        desc: "Իտալական ոճ, թարմ բաղադրիչներ և կատարյալ խրթխրթան եզրեր։",
      },
      {
        icon: "◉",
        title: "Specialty սուրճ",
        dish: "Pour Over · Signature Latte",
        desc: "Single-origin հատիկներ, ճշգրիտ պատրաստում և latte art, որը յուրաքանչյուր բաժակ դարձնում է փոքր արարողություն։",
      },
      {
        icon: "❋",
        title: "Հեղինակային դեսերտներ",
        dish: "Lemon Tart · Tiramisu",
        desc: "Միայն կիտրոնե տարտը բավական է, որպեսզի մարդիկ կրկին վերադառնան։",
      },
      {
        icon: "◇",
        title: "Ջերմ հյուրընկալություն",
        dish: "Ուշադիր · Անձնական · Հոգատար",
        desc: "Անձնակազմ, որը հիշում է ձեզ։ Ջերմ և անկեղծ սպասարկում։",
      },
      {
        icon: "○",
        title: "Հարմարավետ մթնոլորտ",
        dish: "Հանգիստ · Լուսավոր · Ջերմ",
        desc: "Բնական լույս, ջերմ ինտերիեր և մթնոլորտ, որը ստիպում է մնալ մի փոքր ավելի երկար։",
      },
    ],
  },
};
...
const MENU_ITEMS = [
  { category: "Breakfast", categoryRU: "Завтрак", categoryAM: "Նախաճաշ", emoji: "🍳", items: [
    { name: "English Breakfast", nameRU: "Английский завтрак", nameAM: "Անգլիական նախաճաշ",
      ...
      descAM: "Տոստ, աղցան, գյուղական կարտոֆիլ, լոլիկ, երշիկ, բեկոն, ֆետա և 2 ձու", price: "3,700" },
    { name: "The Brunch Bowl", nameRU: "Бранч Боул", nameAM: "The Brunch Bowl",
      ...
      descAM: "Խաշած ձու, շպինատ, ավոկադո, ռիկոտա, չերրի լոլիկ և կինոա", price: "3,900" },
